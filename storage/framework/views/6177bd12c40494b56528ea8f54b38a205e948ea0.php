                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <?php if($data['status'] == 1): ?>
                                                    <td><span class="label" data-toggle="tooltip" data-placement="top" title="Pending" style="color:#000;font-size: 15px;"><span class="material-icons">
                                                        schedule
                                                        </span></span></td>
                                                ...
                                                <?php else: ?>
                                                    <td><td><span  class="label" data-toggle="tooltip" data-placement="top" title="Closed" style="color:#000;font-size: 15px;"><span class="material-icons">
                                                        task_alt
                                                        </span></span></td>
                                                <?php endif; ?>
                                                <td>
                                                ...
                                                <!-- <td>
                                                 ...
                                                 <a href="<?php echo e(url('/leads', [$data['id']])); ?>"><span class="label label-success">View</span></a>   

                                                <a href="<?php echo e(url('/leads/' . $data['id'] . '/edit')); ?>"><span class="label label-warning">Edit</span></a>
                                                
                                                <a href="<?php echo e(url('leads/delete', ['id' => $data['id']])); ?>"  ><span class="label label-danger" onclick="return confirm('Are you sure you want to delete this lead ?')">Delete</span></a> 
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\lead\resources\views/leads/leadview.blade.php ENDPATH**/ ?>