                                    ...
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered display" style="width:100%" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="column-wrap"><a href="<?php echo e(url('/leads', [$data['id']])); ?>"><?php echo e($data['prospect_first_name'].' '.$data['prospect_last_name']); ?></a></td>
                                                <?php
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                    <div class="form-group" id="status" name="status">
                        ...
                        <input type="hidden" class="form-control" name="lead_id" placeholder="Lead Id" value="<?php echo e(isset($data['id'])); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\ANMOL\wamp64\www\cem_leadmanagement\resources\views/notes/list.blade.php ENDPATH**/ ?>