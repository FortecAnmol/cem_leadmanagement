     ...
     $(document).ready(function () {
         ...
         $("#source_id").change(function(){
           ...
           $('.before_append').removeClass('col-md-6').addClass('col-md-12');
            ...
            //alert(camp_id);
                ...
                url: "<?php echo e(route("leads.campname")); ?>",
        ...
        $("#save_particular_lead").click(function(event) {
            ...
            if(total_leads != "" && employee_id != true){
                ...
                url: "<?php echo e(route("leads.assingParticalurleads")); ?>",
                success: function (data) {
                    console.log(data);
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u709485375/domains/fortecsalesforce.com/public_html/cem_leadmanagement/resources/views/leads/assign_lead.blade.php ENDPATH**/ ?>