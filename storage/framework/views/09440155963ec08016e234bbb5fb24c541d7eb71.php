            ...
            <div class="card card-outline-info table-border-none">
                <div class="card-header">
                 ...
                 <div class="button_edit">
                        <a class="button_edit_anchor" href="<?php echo e(url('/employee/lhs_report/edit', [$data['lead_id']])); ?>">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <input class="form-control" type="text" name="prospect_first_name"
                                                value="<?php echo e(ucfirst($lead_info->prospect_first_name) .' '. ucfirst($lead_info->prospect_last_name)); ?>"
                                                readonly>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <input class="form-control" type="text" name="prospect_last_name"
                                                value="<?php echo e($data->board_no); ?>" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <input class="form-control" type="text" name="email"
                                                value="<?php echo e($lead_info->designation); ?>" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <input class="form-control" type="text" name="source_name"
                                                value="<?php echo e($data->direct_no); ?>" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <input class="form-control" type="text" name="contact_number_1"
                                                value="<?php echo e($lead_info->company_name); ?>" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <input class="form-control" type="text" name="contact_number_2"
                                                value="<?php echo e($data->ext_if_any); ?>" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <input class="form-control" type="text" name="industry"
                                                value="<?php echo e($lead_info->industry); ?>" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <input class="form-control" type="text" name="company_name"
                                                value="<?php echo e($lead_info->contact_number_1); ?>" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <input class="form-control" type="text" name="prospect_name"
                                                value="<?php echo e($data->employees_strength); ?>" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <input class="form-control" type="text" name="designation"
                                                value="<?php echo e($lead_info->email); ?>" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <input class="form-control" type="text" name="linkedin_address"
                                                value="<?php echo e($data->revenue); ?>" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <input class="form-control" type="text" name="bussiness_function"
                                                value="<?php echo e($data->ea_name); ?>" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <input class="form-control" type="text" name="designation_level"
                                                value="<?php echo e($data->address); ?>" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <input class="form-control" type="text" name="timezone"
                                                value="<?php echo e($data->ea_contact_number_1); ?>" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <input class="form-control" type="text" name="location"
                                                value="<?php echo e($lead_info->linkedin_address); ?>" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 show_lead">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <input class="form-control" type="text" name="location"
                                                value="<?php echo e($data->ea_email); ?>" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 show_lead">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <input class="form-control" type="text" name="location"
                                                value="<?php echo e($data->prospects_level); ?>" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 show_lead">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <input class="form-control" type="text" name="location"
                                                value="<?php echo e($data->website); ?>" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 show_lead">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <input class="form-control" type="text" name="location"
                                                value="<?php echo e($data->prospect_vertical); ?>" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 show_lead">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <input class="form-control" type="text" name="location"
                                                value="<?php echo e($data->opt_in_status); ?>" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <p class="Heraeus"><?php echo e($data->company_desc); ?></p>
                <div class="card-header">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <textarea class="form-control" type="text" name="prospect_first_name" value=""
                                                readonly=""><?php echo e($data->responsibilities); ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12 mb-4 show_lead">
                                <div class="row ">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <textarea class="form-control" type="text" name="prospect_first_name" value=""
                                                readonly=""><?php echo e($data->team_size); ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12 mb-4 show_lead">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <textarea class="form-control" type="text" name="prospect_first_name" value=""
                                                readonly=""><?php echo e($data->pain_areas); ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12 mb-4 show_lead">
                                <div class="row ">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <textarea class="form-control" type="text" name="prospect_first_name" value=""
                                                readonly=""><?php echo e($data->interest_new_initiatives); ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12 mb-4 show_lead">
                                <div class="row ">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <textarea class="form-control" type="text" name="prospect_first_name" value=""
                                                readonly=""><?php echo e($data->budget); ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12 mb-4 show_lead">
                                <div class="row ">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <textarea class="form-control" type="text" name="prospect_first_name" value=""
                                                readonly=""><?php echo e($data->defined_agenda); ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12 mb-4 show_lead">
                                <div class="row ">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <textarea class="form-control" type="text" name="prospect_first_name" value=""
                                                readonly=""><?php echo e($data->call_notes); ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <textarea class="form-control" type="text" name="source_name" value=""
                                                readonly><?php echo e($data->meeting_teleconference); ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                              ...
                              <div class="form-group">
                                 <label class="control-label labelstyle">Contact's Designation:</label>
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <textarea class="form-control" type="text" name="email" value=""
                                                readonly><?php echo e($data->contact_decision_maker); ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                              ...
                              <div class="form-group">
                                 <label class="control-label labelstyle">Contact's Designation:</label>
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <textarea class="form-control" type="text" name="email" value=""
                                                readonly><?php echo e($data->influencers_decision_making_process); ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                              ...
                              <div class="form-group">
                                 <label class="control-label labelstyle">Contact's Designation:</label>
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <textarea class="form-control" type="text" name="email" value=""
                                                readonly><?php echo e($data->company_already_affiliated); ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row p-t-20">
                            <div class="col-md-6 show_lead">
                                <div class="row ">
                                    ...
                                    <div class="col-md-9">
                                        <div class="form-group">
                                            <input type="text" value="<?php echo e($data->meeting_date1); ?>" class="form-control"
                            ...
                            <div class="col-md-6 show_lead">
                                <div class="row ">
                                    ...
                                    <div class="col-md-9">
                                        <div class="form-group">
                                            <input type="text" value="<?php echo e($data->meeting_time1); ?> <?php echo e($data->timezone_1); ?>" class="form-control" readonly=""
                        ...
                        <div class="row p-t-20">
                            <div class="col-md-6 show_lead">
                                <div class="row ">
                                    ...
                                    <div class="col-md-9">
                                        <div class="form-group">
                                            <input type="text" value="<?php echo e($data->meeting_date2); ?>" class="form-control"
                                                readonly="" name="prospect_first_name">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6 show_lead">
                                <div class="row ">
                                    ...
                                    <div class="col-md-9">
                                        <div class="form-group">
                                            <input type="text" value="<?php echo e($data->meeting_time2); ?> <?php echo e($data->timezone_2); ?>" class="form-control" readonly=""
                                                name="prospect_first_name">
                                        </div>
                                    </div>
                                </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u709485375/domains/fortecsalesforce.com/public_html/lead_updated/resources/views/employees/view_lhs_report.blade.php ENDPATH**/ ?>