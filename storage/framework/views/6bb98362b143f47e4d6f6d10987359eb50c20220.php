                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                               ...
                                               $data_src = App\Models\Lead::where(['source_id'=>$data['id']])->select(DB::raw('COUNT(source_id) as totalLeads'))->groupBy('source_id')->first();                                     
                                                ?>
                                                <?php if(empty($data_src->totalLeads)): ?>
                                                <td>N/A</td>
                                                <?php else: ?>
    ...
    $( document ).ready(function() {
        ...
        $("#assignToManagerPopupBtn").click(function() {
            ...
            if((campaign_id != 0) && (managerId != 0)) {
                window.location.replace("http://localhost/cem_leadmanagement_28_jan/sources/"+campaign_id+"/camp_assign?assignedTo="+managerId);
            } else {
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\cem_leadmanagement_28_jan\resources\views/sources/list.blade.php ENDPATH**/ ?>