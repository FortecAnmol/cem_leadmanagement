                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <input class="form-control" type="text" name="company_industry"
                                                value="<?php echo e($lead_info->company_industry); ?>" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <input class="form-control" type="text" name="designation"
                                                value="<?php echo e($lead_info->prospect_email); ?>" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <input class="form-control" type="text" name="timezone"
                                                value="<?php echo e($data->ea_phone_no); ?>" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\cem_leadmanagement_10_feb\resources\views/employees/view_lhs_report.blade.php ENDPATH**/ ?>