                            ...
                            <div class="card-body">
                                        ...
                                        <select class="form-control"  name="campaign_id" id="campaign_id">
                                            <option value="" selected>Select Campaign</option>
                                                  <?php $__currentLoopData = $campaigns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $campaigns): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                          <?php if($campaign_id == $campaigns['source']['id']): ?>
                                                                      <option value="<?php echo e($campaigns['source']['id']); ?>" selected><?php echo e($campaigns['source']['source_name']); ?> (<?php echo e($campaigns['source']['description']); ?>)</option>
                                                                  <?php else: ?> 
                                                                      <option value="<?php echo e($campaigns['source']['id']); ?>"><?php echo e($campaigns['source']['source_name']); ?>  (<?php echo e($campaigns['source']['description']); ?>)</option>
                                                                   <?php endif; ?> 
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label class="control-label">Date From</label>
                                            <input type="datetime-local" class="form-control date_from_new" placeholder="Date From" name="date_from" value="<?php echo e($date_from); ?>" id="date_from_new">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="datetime-local" class="form-control date_from_new" placeholder="Date To" name="date_to" value="<?php echo e($date_to); ?>"  id="date_to_new">
                                    </div>
                                </div>
                                ...
                                <div class="form-group" style="
                                    ...
                                    width: 100%;">
                                    <br>
                                    <a type="button" style="display: none" href="<?php echo e(url('/notes_new')); ?>" class="btn btn-success addButton"> Fixing status in notes table </a>
                                    <a type="button" href="<?php echo e(url('/employee/'.auth()->user()->id.'/emp_daily_report'.$urls)); ?>" class="btn btn-success addButton"> Export Report </a>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\ANMOL\wamp64\www\cem_leadmanagement\resources\views/employees/emp_daily_report.blade.php ENDPATH**/ ?>