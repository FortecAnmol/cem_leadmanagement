                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="email" name="email" class="form-control form-control-danger" placeholder="Enter Email" value="<?php echo e($data->email); ?>">
                                         ...
                                         <div class="row p-t-20">
                                            <div class="col-md-6">
                                                ...
                                                <label class="control-label">Organization  Industry</label>
                                                    <input type="text" id="industry" name="industry" class="form-control" placeholder="Enter Organization Industry" value="<?php echo e($data->industry); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\lead_updated\resources\views/leads/edit.blade.php ENDPATH**/ ?>