                     ...
                     <div class="row">
                        <div class="col-md-12">
                           <div class="form-group">
                              ...
                              <textarea placeholder="Enter Call Notes" id="call_notes" name='call_notes' required class="form-control"><?php echo e(old('call_notes')); ?></textarea>
                           </div>
                        </div>
                     </div>
                     <div class="row">
                     ...
                     <div class="row">
                        <div class="col-md-3">
                           <div class="form-group">
                              ...
                              <input type="date" class="form-control date" required placeholder="23-Dec-21" name="meeting_date1" value="<?php echo e(old('meeting_date1')); ?>" >
                           </div>
                        </div>
                        <div class="col-md-3">
                           <div class="form-group">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u709485375/domains/fortecsalesforce.com/public_html/cem_leadmanagement/resources/views/employees/export_Lhs.blade.php ENDPATH**/ ?>