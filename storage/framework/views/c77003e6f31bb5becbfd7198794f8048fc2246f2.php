                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="email" name="email" class="form-control form-control-danger" placeholder="Enter Email" value="<?php echo e(old('email')); ?>">
                                         ...
                                         <div class="row p-t-20">
                                            <!--<div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="industry" name="industry" class="form-control" placeholder="Enter Industry" value="<?php echo e(old('industry')); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u709485375/domains/fortecsalesforce.com/public_html/cem_leadmanagement/resources/views/leads/add.blade.php ENDPATH**/ ?>