                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <?php if(isset($_GET["status"])){  ?>
                               <input type="hidden" id="lead_status" name='status'class="form-control" placeholder="NA" value="<?php echo e(intval($_GET["status"])); ?>">
                               <?php } ?>
                               <input type="hidden" id="previous_url" name='previous_url'class="form-control" placeholder="NA" value="<?php echo e(URL::previous()); ?>">
                     ...
                     <div class="row">
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <input type="text" id="company_industry" name='company_industry'class="form-control" placeholder="Enter Industry" readonly value="<?php echo e($data->company_industry); ?>">
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <input type="text" id="prospect_email" name='prospect_email' class="form-control" placeholder="Enter Email" readonly value="<?php echo e($data->prospect_email); ?>">
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <input type="text" id="ea_phone_no" name='ea_phone_no'class="form-control" placeholder="Enter EA Phone Number" value="<?php echo e(old('ea_phone_no')); ?>">
                     ...
                     <div class="row">
                        <div class="col-md-12">
                           <div class="form-group">
                              ...
                              <textarea placeholder="Enter Company Description" id="editor" name='company_desc' value="<?php echo e(old('company_desc')); ?>" class="form-control company_desc"><?php echo e(old('company_desc')); ?></textarea>
                              <?php if($errors->has('company_desc')): ?>
                              <div class="alert alert-danger"><?php echo e($errors->first('company_desc')); ?></div>
                              <?php endif; ?>
                           </div>
                        </div>
                     </div>
                     <div class="row">
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <div class="alert alert-danger"><?php echo e($errors->first('responsibilities')); ?></div>
                              <?php endif; ?>
                           </div>
                        </div>
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <div class="alert alert-danger"><?php echo e($errors->first('team_size')); ?></div>
                              <?php endif; ?>
                           </div>
                        </div>
                     </div>
                     <div class="row">
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <?php if($errors->has('pain_areas')): ?>
                              <div class="alert alert-danger"><?php echo e($errors->first('pain_areas')); ?></div>
                              <?php endif; ?>
                           </div>
                        </div>
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <?php if($errors->has('interest_new_initiatives')): ?>
                              <div class="alert alert-danger"><?php echo e($errors->first('interest_new_initiatives')); ?></div>
                              <?php endif; ?>
                           </div>
                        </div>
                     </div>
                     <div class="row">
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <div class="alert alert-danger"><?php echo e($errors->first('budget')); ?></div>
                              <?php endif; ?>
                           </div>
                        </div>
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <?php if($errors->has('defined_agenda')): ?>
                              <div class="alert alert-danger"><?php echo e($errors->first('defined_agenda')); ?></div>
                              <?php endif; ?>
                           </div>
                        </div>
                     </div>
                     <div class="row">
                        <div class="col-md-12">
                           <div class="form-group">
                              ...
                              <textarea placeholder="Enter Call Notes" id="editor" name='call_notes'  class="form-control editor"><?php echo e(old('call_notes')); ?></textarea>
                              <?php if($errors->has('call_notes')): ?>
                              <div class="alert alert-danger"><?php echo e($errors->first('call_notes')); ?></div>
                              <?php endif; ?>
                           </div>
                        </div>
                     </div>
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <select id="meeting_teleconference"  name='meeting_teleconference'class="form-control">
                                 <?php if(old('meeting_teleconference') !== NULL): ?>
                                 <option value="<?php echo e(old('meeting_teleconference')); ?>"><?php echo e(old('meeting_teleconference')); ?></option> 
                                 <?php else: ?>
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <select id="contact_decision_maker" name='contact_decision_maker'class="form-control">
                                 <?php if(old('contact_decision_maker') !== NULL): ?>
                                 <option value="<?php echo e(old('contact_decision_maker')); ?>"><?php echo e(old('contact_decision_maker')); ?></option> 
                                 <?php else: ?>
                                 <option vlaue="">Select Any Option</option> 
                                 <?php endif; ?>
                     ...
                     <div class="row">
                        <div class="col-md-3">
                           <div class="form-group">
                              ...
                              <input type="date"  class="form-control date"  placeholder="23-Dec-21" name="meeting_date1" value="<?php echo e(old('meeting_date1')); ?>" >
                           </div>
                           <?php if($errors->has('meeting_date1')): ?>
                           <div class="alert alert-danger"><?php echo e($errors->first('meeting_date1')); ?></div>
                           <?php endif; ?>
                        </div>
                        <div class="col-md-3">
                           <div class="form-group">
                              <label class="control-label">Time 1:</label>
                              <input type="time" class="form-control" value="<?php echo e(old('meeting_time1')); ?>" id="appt"  name="meeting_time1">                          
                            </div>
                            <?php if($errors->has('meeting_time1')): ?>
                           <div class="alert alert-danger"><?php echo e($errors->first('meeting_time1')); ?></div>
                           <?php endif; ?>
                        </div>
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <select id="time_zone" required name='timezone_1' class="form-control" >
                                 <?php if(old('timezone_1') !== NULL): ?>
                                 <option value="<?php echo e(old('timezone_1')); ?>"><?php echo e(old('timezone_1')); ?></option> 
                                 <?php else: ?>
                                 ...
                                 <option vlaue=<?php echo e(strtoupper($tzzlist[$i])); ?>> <?php echo e(strtoupper($tzzlist[$i])); ?></option> 
                                 <?php $i++;?>
                                 <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                              </select>
                           </div>
                           <?php if($errors->has('timezone_1')): ?>
                        <div class="alert alert-danger"><?php echo e($errors->first('timezone_1')); ?></div>
                        <?php endif; ?>
                        </div>
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-3">
                           <div class="form-group">
                              ...
                              <input type="date" class="form-control date" placeholder="23-Dec-21" name="meeting_date2" value="<?php echo e(old('meeting_date2')); ?>" >
                           </div>
                           <?php if($errors->has('meeting_date2')): ?>
                           <div class="alert alert-danger"><?php echo e($errors->first('meeting_date2')); ?></div>
                           <?php endif; ?>
                        </div>
                        <div class="col-md-3">
                           <div class="form-group">
                              <label class="control-label">Time 2:</label>
                              <input type="time" class="form-control" value="<?php echo e(old('meeting_time2')); ?>" id="appt" name="meeting_time2">                           
                              <?php if($errors->has('meeting_time2')): ?>
                              <div class="alert alert-danger"><?php echo e($errors->first('meeting_time2')); ?></div>
                              <?php endif; ?>
                           </div>
                        </div>
                     <div class="col-md-6">
                        <div class="form-group">
                           ...
                           <select id="time_zone" required name='timezone_2'class="form-control">
                              <?php if(old('timezone_2') !== NULL): ?>
                              <option value="<?php echo e(old('timezone_2')); ?>"><?php echo e(old('timezone_2')); ?></option> 
                              <?php else: ?>
                              <option vlaue="">Select An Timezone</option> 
                              <?php endif; ?>
                              <?php $i=0; ?>
                        ...
                        <?php if($errors->has('timezone_2')): ?>
                        <div class="alert alert-danger"><?php echo e($errors->first('timezone_2')); ?></div>
                        <?php endif; ?>
                     </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\ANMOL\wamp64\www\cem_leadmanagement\resources\views/employees/export_Lhs.blade.php ENDPATH**/ ?>