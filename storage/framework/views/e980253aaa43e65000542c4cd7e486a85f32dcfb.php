                                        ...
                                        <div class="row p-t-20">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <textarea id="description1" name="description"  maxlength="255" placeholder="Enter Sub-campaign" rows="5" cols="50"><?php echo e(old('description')); ?></textarea>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\ANMOL\wamp64\www\cem_leadmanagement\resources\views/sources/add.blade.php ENDPATH**/ ?>