 ...
 <div class="container-fluid">
                ...
                <div class="row">
                 ...
                 <div class="button_edit edit_leads">
                        <a class="button_edit_anchor" href="<?php echo e(url('/leads/'.$lead_ID.'/edit')); ?>">
                                    ...
                                    <div class="form-body vw-lead ">
                                     ...
                                     <div class="row p-t-20">
                                            ...
                                            <div class="col-md-6 show_lead">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-8">
                                                        ...
                                                        <input class="form-control" type="text" name="prospect_name" value="<?php echo e($data['prospect_first_name']); ?> <?php echo e($data['prospect_last_name']); ?>" readonly>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                                <?php $__currentLoopData = $record['notes']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    <!--<td><?php echo e($record['created_at']); ?></td>-->
                                                    
                                                    <td class="feedback_td" width="300"><p class="notes_comment"><?php echo e($record['feedback']); ?></p></td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\ANMOL\wamp64\www\cem_leadmanagement\resources\views/leads/show.blade.php ENDPATH**/ ?>