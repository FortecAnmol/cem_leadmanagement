                  ...
                  <div class="form-body ">
                     ...
                     <div class="row">
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <input type="text" id="industry" name='industry'class="form-control" placeholder="Enter Industry" readonly value="<?php echo e($lead_info->industry); ?>">
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <input type="text" id="email" name='email' class="form-control" placeholder="Enter Email" readonly value="<?php echo e($lead_info->email); ?>">
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <input type="text" id="ea_contact_number_1" name='ea_contact_number_1'class="form-control" placeholder="Enter EA Phone Number" value="<?php echo e($data->ea_contact_number_1); ?>">
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                              <label class="control-label"></label>
                              <input type="text" id="meeting_teleconference" name='meeting_teleconference'class="form-control" placeholder="Teleconference" value="<?php echo e($data->meeting_teleconference); ?>">
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                              <label class="control-label"></label>
                              <input type="text" id="contact_decision_maker" name='contact_decision_maker'class="form-control" placeholder="Yes/No" value="<?php echo e($data->contact_decision_maker); ?>">
                     ...
                     <div class="row">
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <input type="date" class="form-control" placeholder="23-Dec-21" name="meeting_date1" value="<?php echo e($data->meeting_date1); ?>" >
                           </div>
                        </div>
                        <div class="col-md-6">
                           <div class="form-group">
                              <label class="control-label">Date 1:</label>
                              <input type="date" class="form-control" placeholder="23-Dec-21" name="meeting_date2" value="<?php echo e($data->meeting_date2); ?>" >
                           </div>
                        </div>
                     </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\lead\resources\views/employees/edit_export_Lhs.blade.php ENDPATH**/ ?>