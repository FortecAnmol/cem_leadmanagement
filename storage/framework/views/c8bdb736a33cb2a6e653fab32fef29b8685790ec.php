                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-xlg-3 col-md-5">
                        <div class="card" style="height: 95%;">
                            <div class="card-body">
                                <center class="m-t-30"> <img src="<?php if(!empty($data->image)): ?>
                                    <?php echo e(url('storage/app/images/'.$data->image)); ?>

                                <?php else: ?>
                                  <?php echo e(url('storage/app/images/default.jpg')); ?>

                                <?php endif; ?>" class="img-circle" width="150" />
                                    <h4 class="card-title m-t-10"><?php echo e($data->name); ?></h4>
                        ...
                        <div class="card">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active" id="settings" role="tabpanel">
                                    ...
                                    <form class="form-horizontal form-material" method='post' action="<?php echo e(route('profileUpdate')); ?>" enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?>

                                            <div class="form-group">
                                                <label class="col-md-12">First Name</label>
                                                <div class="col-md-12">
                                                    <input type="text" name="prospect_first_name" placeholder="Enter First Name" class="form-control form-control-line" value="<?php echo e($data->prospect_first_name); ?>">
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                    <input type="text" name="prospect_last_name" placeholder="Enter Last Name" class="form-control form-control-line" value="<?php echo e($data->prospect_last_name); ?>">
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                    <input type="text" name="prospect_email" placeholder="Enter Email" class="form-control form-control-line" value="<?php echo e($data->prospect_email); ?>" readonly>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                    <input type="text" name="contact_number_1" placeholder="Enter Phone No" class="form-control form-control-line" value="<?php echo e($data->contact_number_1); ?>" readonly>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                    <input type="text" name="address" placeholder="Enter Address" class="form-control form-control-line" value="<?php echo e($data->address); ?>">
                                                </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u709485375/domains/fortecsalesforce.com/public_html/cem_leadmanagement/resources/views/profiles/profile.blade.php ENDPATH**/ ?>